export const sendAPI = (info) => {
    ...
    fetch(`https://script.google.com/macros/s/AKfycbxSi0d08RUd2fSObwNE77mRFhS_8FSRdCMwSOIWT06yDrZ2jKeT6Xa0EE3NsWG-HDiqog/exec?${name1}=${value1}&${name2}=${value2}&${name3}=${value3}&${name4}=${value4}&${name5}=${value5}&${name6}=${value6}&${name7}=${value7}&${name8}=${value8}&${name9}=${value9}&${name10}=${value10}`, requestOptions)
