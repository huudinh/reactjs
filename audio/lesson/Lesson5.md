...
### Lấy tiêu đề của bài hát làm title
...
function App() {
  ...
  const bgAudioRef = useRef(null); // Tham chiếu đến phần tử audio của nhạc nền
   ...
   useEffect(() => {
    document.title = currentSong.title; // Đặt tiêu đề bài hát làm title
...
### Chạy audio khi click vào tên bài hát trong danh sách

Cập nhật hàm handleSelectSong trong file App.jsx
